...
export default function Triangle({ ...props }) {
  ...
  const group = useRef()
  const { nodes, materials } = useGLTF('/models/GLTF_triangle_noautomaticlight_3/triangle.gltf')
...
useGLTF.preload('/models/GLTF_triangle_noautomaticlight_3/triangle.gltf')
